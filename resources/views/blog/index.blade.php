...
<head>
    ...
    <title>Blog CRUD - Irvan Maulana</title>
...
<body style="background: lightgray">
                ...
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <!-- menampilkan data blog kita menggunakan perulangan forelse -->
                            @empty
    ...
    <!-- menampilkan alert setelah berhasil menambahkan data -->
    <script>
        //menggunakan library toastr
